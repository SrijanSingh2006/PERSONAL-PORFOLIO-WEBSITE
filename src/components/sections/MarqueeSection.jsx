      ...
      <div className="flex flex-col gap-3">
        ...
        >
          {tripleRow1.map((src, idx) => (
            <div
              key={idx}
              className="w-[320px] sm:w-[380px] md:w-[420px] h-[200px] sm:h-[240px] md:h-[270px] flex-shrink-0 rounded-2xl overflow-hidden bg-[#161616] border border-[#222]"
            >
              <img
                src={src}
                alt="AI / 3D Project Preview"
                loading="lazy"
